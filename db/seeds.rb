...
a8 = Album.create(cover: "http://bit.ly/1DwIoBp", title: "Beats Rhymes & Life", artist: "A Tribe Called Quest")
Track.create(name: "Phony Rappers", minutes: 9, album_id: a8.id)
Track.create(name: "Get a Hold", minutes: 6, album_id: a8.id)
Track.create(name: "Motivators", minutes: 8, album_id: a8.id)
Track.create(name: "The Jam", minutes: 8, album_id: a8.id)
Track.create(name: "Crew", minutes: 7, album_id: a8.id)
Track.create(name: "The Pressure", minutes: 8, album_id: a8.id)
Track.create(name: "1nce Again", minutes: 5, album_id: a8.id)
Track.create(name: "Mind Power", minutes: 8, album_id: a8.id)
Track.create(name: "The Hop", minutes: 9, album_id: a8.id)
Track.create(name: "Keeping It Moving", minutes: 8, album_id: a8.id)
Track.create(name: "Baby Phife's Return", minutes: 8, album_id: a8.id)
Track.create(name: "Seperate Together", minutes: 8, album_id: a8.id)
Track.create(name: "What Really Goes On", minutes: 8, album_id: a8.id)
Track.create(name: "Word Play", minutes: 8, album_id: a8.id)
Track.create(name: "Stressed Out", minutes: 8, album_id: a8.id)

a9 = Album.create(cover: "http://ecx.images-amazon.com/images/I/51RzfiTImqL.jpg", title: "Illmatic", artist: "Nas")
Track.create(name: "The Genesis", minutes: 9, album_id: a9.id)
Track.create(name: "N.Y. State of Mind", minutes: 6, album_id: a9.id)
Track.create(name: "Life's a Bitch", minutes: 8, album_id: a9.id)
Track.create(name: "The World is Blind", minutes: 8, album_id: a9.id)
Track.create(name: "Halftime", minutes: 7, album_id: a9.id)
Track.create(name: "Memory Lane", minutes: 8, album_id: a9.id)
Track.create(name: "One Love", minutes: 5, album_id: a9.id)
Track.create(name: "Ont Time 4 Your Mind", minutes: 8, album_id: a9.id)
Track.create(name: "Represent", minutes: 9, album_id: a9.id)
Track.create(name: "It Ain't Hard to Tell", minutes: 8, album_id: a9.id)
